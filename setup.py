...
class SwigCommand(Command):
    ...
    def run(self):
        ...
        cmd = ["swig", "-python", "-c++", "-threads", "-outdir", "PyIndi"] + swig_opts + [swig_file_path]
        ...
        try:
            ...
            wrapper_file = "indiclientpython_wrap.cxx" # Should still be generated in root
            ...
            if not os.path.exists(python_module):
                print(f"Error: {python_module} was not generated by SWIG in the PyIndi directory")
...
setup(
    name="pyindi-client",
    version="2.1.8",  # Match version in pyproject.toml
    zip_safe=False,
